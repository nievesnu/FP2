...
typedef struct {
	tPeli* arrayPelis[MAX_Pelis]; //punturo apunta al array de hasta 50 
	int numPelis;
}tListaPelis;
...
typedef struct {
	tEntradas* arrayEntradas; //array dinamico
...
bool procesarEntradas(tListaPelis& listaP, tListaPeticiones& listaEn, int suma); //gestiona las solicitudes de entradas
